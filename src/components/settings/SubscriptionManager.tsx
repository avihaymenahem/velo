  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder={t("subscriptionManager.searchSenders")}
      ...
      <p className="text-xs text-text-tertiary">
        {t("subscriptionManager.sendersDetected", { count: subscriptions.length })}
      </p>
            ...
            >
              ...
              {!isUnsubscribed && (
                ...
                >
                  ...
                  {isLoading ? "..." : t("subscriptionManager.unsubscribe")}
                </button>
              )}
            </div>
          );
