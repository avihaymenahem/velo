    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        <input
          ...
          placeholder={t("contactEditor.searchContacts")}
      ...
      {filtered.length === 0 ? (
        <p className="text-sm text-text-tertiary py-2">
          {search ? t("contactEditor.noMatchingContacts") : t("contactEditor.noContacts")}
        </p>
      ) : (
      ...
      <p className="text-xs text-text-tertiary">
        {t("contactEditor.contactCount", { count: contacts.length })}
      </p>
    </div>
  );
}
