...
function describeActions(actionsJson: string, t: (key: string) => string): string {
  try {
    ...
    return t("quickStepEditor.invalidActions");
  }
}
                    ...
                    <div className="flex-1 space-y-1">
                      ...
                      {needsSnoozeDuration && (
                        ...
                        >
                          ...
                          <option value={3600000}>{t("quickStepEditor.1hour")}</option>
                          <option value={14400000}>{t("quickStepEditor.4hours")}</option>
                          <option value={86400000}>{t("common.tomorrow")}</option>
                          <option value={172800000}>{t("quickStepEditor.2days")}</option>
                          <option value={604800000}>{t("quickStepEditor.1week")}</option>
                        </select>
                      )}
                    </div>
                    <button
