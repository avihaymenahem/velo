  ...
  return (
    <div className="px-3 py-2 border-b border-border-secondary bg-accent/5">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-xs font-medium text-accent">{t("ai.assist")}</span>
      </div>
      ...
      <div className="flex items-center gap-2 mb-2">
        <input
          ...
          placeholder={isReplyMode ? t("ai.instructionsPlaceholder") : t("ai.describePlaceholder")}
      ...
      <div className="flex items-center gap-1.5">
        <span className="text-xs text-text-tertiary mr-1">{t("ai.transform")}</span>
        <QuickAction
          icon={<Wand2 size={11} />}
          label={t("ai.improve")}
